...
import com.isnakebuzz.survivalgames.Utils.Plugin.MetricsLite;
...
public final class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (Bukkit.getPluginManager().isPluginEnabled("PlaceholderAPI")) {
            ...
            new SurvivalGamesHolders(this).register();
    ...
    public void onDisable() {
        // Removed for bug this.arenaManager.unloadArenas();
        MySQL.disconnect();
        Bukkit.getOnlinePlayers().forEach(o -> o.kickPlayer(c("&cRestarting SurvivalGames plugin, please join later. \n&cPlease don't use \"/reload\" if you are using a production server :) \n")));
    }
