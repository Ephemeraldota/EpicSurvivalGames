...
public class Commands implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (cmd.getName().equalsIgnoreCase("SurvivalGames")) {
            ...
            if (subCmd.equalsIgnoreCase("loadWorld")) {
                if (args.length < 2) {
                    sender.sendMessage(c("&a➠&e /sg loadWorld {worldName}"));
                    return true;
                }
            ...
            if (subCmd.equalsIgnoreCase("setLobby")) {
                ...
                if (action.equalsIgnoreCase("tp")) {
                    ...
                    if (world != null) {
                        ...
                        p.sendMessage(c("&a➠&c World don't exist."));
                    }
                }
    ...
    public void sendHelp(CommandSender p) {
        ...
        if (p.hasPermission("survivalgames.admin")) {
            p.sendMessage(c("&a➠&e /sg &dsetLobby &8| &7 Set a principal lobby"));
            p.sendMessage(c("&a➠&e /sg &darena &8| &7 Arena commands"));
            p.sendMessage(c("&a➠&e /sg &dloadWorld &b{worldName} &8|&7 Load arena world"));
            p.sendMessage(c("&a➠&e /sg &djoin &b{name} &8| &7 Join a arena"));
        } else {
            p.sendMessage(c("&a➠&e /sg join {name} &8| &7 Join a arena"));
            p.sendMessage(c(""));
    ...
    public void sendArenaHelp(CommandSender p) {
        p.sendMessage(c("&e&lSurvivalGames &a&lv" + plugin.getDescription().getVersion()));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6tp &8| &7 Tp to arena"));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6create &8| &7 Create a arena"));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6publicName {signs name} &8| &7 Set name for signs"));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6addSpawn &8| &7 Add spawnpoint"));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6setLobby &8| &7 Set lobby"));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6s etSpect &8| &7 Set spectator"));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6setMin {minimun players} &8| &7 Set min players"));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6setMax {maximun players} &8| &7 Set max players"));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6setStarting {starting time}"));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6setGrace {grace period}"));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6setGameStarting {game starting time}"));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6setForced {starting time}"));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6setEnd {starting time}"));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6removeSpawn &8| &7 Remove latest spawnpoint"));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6saveMap &8| &7 Save map"));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6delete &8| &7 Delete arena"));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6enable &8| &7 Enable arena"));
        p.sendMessage(c("&a➠&e /sg &darena &b{name} &6disable &8| &7 Disable arena"));
    }
