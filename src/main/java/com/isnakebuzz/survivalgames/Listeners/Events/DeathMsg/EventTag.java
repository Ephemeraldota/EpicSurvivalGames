...
public class EventTag implements Listener {
    ...
    static HashMap<LivingEntity, LivingEntity> lastDamager;
    static HashMap<LivingEntity, Integer> lastDmgTime;
    private static Main plugin;

    static {
        EventTag.lastDamager = new HashMap<>();
        EventTag.lastDmgTime = new HashMap<>();
    }
