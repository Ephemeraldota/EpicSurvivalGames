...
public class LobbyManager {
    ...
    public void removeLobby(Player p) throws IOException {
        ...
        //Removed for MC version update p.playSound(p.getLocation(), Sound.CHICKEN_EGG_POP, 1, 0);
    }
    ...
    public void setLobby(Player p) throws IOException {
        ...
        //Removed for MC version update p.playSound(p.getLocation(), Sound.CHICKEN_EGG_POP, 1, 1);
    }
